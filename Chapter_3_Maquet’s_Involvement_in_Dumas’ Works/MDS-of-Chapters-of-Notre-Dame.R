M <- loadCorpus("C:/Users/cobet/Documents/corpus_files/SupervisedOfNotreDame/", "frequentwords100")
...
names <- c("Dumas", "Collab", "Hugo", "Maquet", "Stendhal", "Notre Dame Chapters")
colours <- c("red", "blue", "green", "purple", "orange") # Assign colours to authors
